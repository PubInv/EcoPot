# Public Invention Free-Culture License Guidelines (v0.1) for the [More Efficient Pot] project
...
In cases where copyright law does not apply, we ask that you follow normal academic ethics and etiquette by giving the authors academic credit by name 
for text, data compilations, theorems, etc. Do not plagiarize. 
...
[Since] \[Public Invention\] is a legal entity, volunteers are expected to assign the copyright of work done on \[More Efficient Pot\] to \[Public Invention\] 
so that in a copyright dispute there is a single copyright holder (\[Public Invention\]) to simplify things. 
\[Public Invention\] will continue to attribute the work to original author where feasible.
